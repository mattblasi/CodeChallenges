/*
Sparse Arrays Javascript Solution
...
function matchingStrings(stringList, queries) {
    ...
    // map function returns array of each item
    // internal filter gets length (count) of matches
    return queries.map(x => stringList.filter(y => y === x).length);
}
